...
const perks = [
  {
    ...
    description: "Get your Pets delivered to your email in seconds" 
  },
  {
    name: 'Guaranteed Quality',
    Icon: CheckCircle,
    description: "Every assets on our platform is verified by our team to ensure our highest quality. Not happy? We offer a 30-day refund guarantee." 
  },
  {
    name: 'For the Planet ',
    Icon: Leaf,
  ...
  return (
    ...
    <section className="border-t border-gray-200 bg-gray-50">
      <MaxWidthWrapper className="py-20">
        <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8 lg:gab-y-0">
          {perks.map((perk)=>(
            <div 
              key={perk.name} 
